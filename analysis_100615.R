...
repeats <- rbind(read.delim(file = paste0(path,"cdc2as_tp11_repeat_0.txt"), stringsAsFactors=F, header = T, skip = 3),read.delim(file = paste0(path,"cdc2as_tp11_repeat_1.txt"), stringsAsFactors=F, header = T, skip = 3))

areas_1 <- list (cdc2[[1]][,3],cdc2[[2]][,3], cdc2[[3]][,3],cdc2[[4]][,3],
								 cdc2[[5]][,3],cdc2[[6]][,3],cdc2[[7]][,3],cdc2[[8]][,3],
								 cdc2[[9]][,3],cdc2[[10]][,3], cdc2[[11]][,3], repeats[,3])
